...
const ReceiptOldDraft = ({
  ...
  const receiptDate = formData.receipt_date;
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-xl">
            Receipt Preview {formData.receipt_financial_year}
          </DialogTitle>
          <DialogDescription>
            Review the receipt details before final submission. Click "Save &
            Create Receipt" to proceed or "Cancel" to go back.
          </DialogDescription>
        </DialogHeader>
            ...
            <table className="w-full border-t border-black border-collapse text-[12px]">
              <tbody>
                  ...
                  <td className="border-l border-black" rowSpan="2">
                    <div className="ml-6 font-bold">
                      <p className="text-sm leading-tight">
                        ...
                        {donorData.indicomp_type === "Individual" &&
                          donorData.title}{" "}
                ...
                <tr>
                  ...
                  <td className="border-r border-t border-black p-1">
                    <span className="font-bold">
                      {formData.receipt_tran_pay_mode}
                    </span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  >
                    ...
                    <span className="font-bold text-sm">
                      {formData.receipt_tran_pay_details}
                    </span>
                  </td>
                </tr>
                      ...
                      <div className="text-[12px]">
                        {moment(receiptDate).isAfter("2021-05-27") ? (
                          <>
                            ...
                            <br />
                            Income Tax Act 1961 vide Order No. AAAAF0290LF20214
                            Dt. 28-05-2021.
                          </>
                        ) : (
                          <>
...
export default ReceiptOldDraft;
